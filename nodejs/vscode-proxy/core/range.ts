...
export class Range {
  ...
  constructor() {
    if (arguments.length === 4) {
      this.startLineNumber = arguments[0];
      this.startColumn = arguments[1];
      this.endLineNumber = arguments[2];
      this.endColumn = arguments[3];
      this.start = new Position(this.startLineNumber, this.startColumn);
      this.end = new Position(this.endLineNumber, this.endColumn);
    } else {
      this.start = arguments[0];
      this.end = arguments[1];
      this.startLineNumber = this.start.line;
      this.startColumn = this.start.column;
      this.endLineNumber = this.end.line;
      this.endColumn = this.end.column;
    }
  }
  ...
  public with(start: IPosition = this.start, end: IPosition = this.end): Range {
    return new Range(start.line, start.column, end.line, end.column);
  }
